...
A solution designed to help individuals understand, track, and reduce their carbon footprint through simple actions and personalized AI-driven insights.
...
1. **Activity Logging & Ingestion**: Track transit (car, flight, public transport), home utilities (electricity, water, heating), and food choices.
2. **Personalized Insights Engine**: Ingest footprint data and use AI to output clear, action-oriented, and realistic reduction steps.
3. **Data Visualization**: Translate numbers (e.g. kg of CO2) into relatable narratives and visual trends.
4. **Gamified Actions & Badges**: Simple daily challenges to build low-carbon habits.

---

## Installed Skills
The project has been pre-configured with specialized agent skills located in `.agent/skills/` to assist in design, database schema modeling, backend architecture, and AI personalization.
...
## 5. What to Submit
> [!NOTE]
> For a detailed guide on how to submit, please refer to the document [Link](Link).
